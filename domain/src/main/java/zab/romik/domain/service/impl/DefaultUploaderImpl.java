...
import zab.romik.domain.properties.FileUploadProperties;
import zab.romik.domain.service.FileNamingStrategy;
import zab.romik.domain.service.Uploader;
...
public class DefaultUploaderImpl implements Uploader {
    ...
    /**
     * Свойства для сервиса загрузки файлов
     */
    ...
    public String uploadMultipartFile(MultipartFile file) {
        ...
        return FileUploader.newInstance(
                file, fileNamingStrategy,
                fileUploadProperties.getLocation()
        ).transferFile();
    }
